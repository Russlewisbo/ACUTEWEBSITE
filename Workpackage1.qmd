...
plot(fit1, xlab = "CAZ/AVI serum conc. (mg/L)", ylab = "Tpos (hr)")
```
...
fit13 <- drda(tpos ~ coli_s, data=coli1, mean_function = "loglogistic4", max_iter = 1000)
plot(fit13, xlab = "Colistin serum conc. (mg/L)", ylab = "Tpos (hr)")
...
plot(fit14, xlab = "Tigecycline serum conc. (mg/L)", ylab = "Tpos (hr)")
...
set.seed(12345)
cutoff <- 0.95
caz_gent_kpca2 <- read.csv("~/Desktop/ACUTEWEBSITE/datasets_combo/caz_gent_kpca.csv")
## Fitting marginal models, maximal fixed at 24 hours, minimal at 9.5 hours
