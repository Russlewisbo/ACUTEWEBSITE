...
plot(fit11, xlab = "Meropenem serum conc. (mg/L)", ylab = "Tpos (hr)")
...
library (readxl)
library(drda)
mero_c1 <- read_excel("datasets_single/meropenem_drug_mic.xlsx")
fitmero <- drda(tpos ~ serum_mic, data=mero mean_function = "loglogistic4", max_iter = 1000)
...
-   The activity of combination ceftazidime/avibactam (4 to 1 ratio from analytical powder) plus gentamicin was tested against ***Klebsiella pneumonia*****\_KPC_A strain** in 5 replicate experiments using the same methodology.
