...
**The ACUTE project** (**A**dapting Blood**cu**lture systems **t**o monitor antimicrobial **e**fficacy) proposes to develop time-to positivity (Tpos)- a commonly recorded measurement from continuously monitored bloodculture systems in clinical microbiology laboratories - as a (pharmacodynamic) biomarker for monitoring antibiotic therapy of multidrug resistant (MDR) gram-negative bacteria.
