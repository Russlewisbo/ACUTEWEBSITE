...
**The ACUTE project** proposes to develop *time-to positivity (Tpos)*- a common measurement from continuously monitored bloodculture systems used in clinical microbiology laboratories - as a surrogate pharmacodynamic marker for monitoring antibiotic therapy of multidrug resistant (MDR) gram-negative bacteria.
