...
[Figure 1. Tpos vs. test inoculum]. shows the relationship between Tpos and the *K. pneumoniae* inoculum fitted by linear regression. A linear relationship was evident from approximately 10^1^-10^8^ *K. pneumoniae* CFU/mL and a Tpos measured from 10.5 hours-4.5 hours over the tested inoculum range. *These data suggest Tpos has a high dynamic range as an indicator for viable CFU/mL.*
...
scale_x_log10(name="Log Caz/AVI, mg/L") +
