---
title: "Workpackage 1-Single Drug Regimens"
date: "12/14/2022"
format: 
  html:
    code-fold: true
...
This workpackage explores how cantibiotic concentrations alters Tpos for a standard (1x10^4^ CFU/mL) inoculum of Enterobacterales. For experiments with Non-fermentor (Acinetobacter baumanii and Pseudomonas aeruginosa, see [Nonfermentors](Nonfermontors.qmd) ) link.
...
#### K. pneumoniae ATCC 700603 isolate (MIC 0.03 mg/L) powder 4:1
...
#### KPC B isolate (MIC 1 mg/L) commercial 
...
#### KPC B isolate (MIC 1 mg/L) powder 4:1
...
#### KPC A isolate (MIC 2 mg/L) commerical
...
#### KPC A isolate (MIC 2 mg/L) powder 4:1
...
#### KPC A isolate (MIC 2 mg/L) fixed 4 mg/L
...
#### KPC B isolate (MIC 1 mg/L) fixed 4 mg/L
...
#### KPC B isolate (MIC 1 mg/L) high inoculum
...
#### KPC Catania isolate (MIC 16 mg/L) powder 4:1
...
#### KPC Catania isolate (MIC 16 mg/L) fixed 4 mg/L
...
#### KPC B isolate (MIC X mg/L) commerical
...
#### K. pneumonia KPC-A (MIC 0.75 mg/L) powder
...
#### K. pneumoniae KPC-B (MIC 0.38 mg/L) powder
...
#### K. pneumoniae KPC-B (MIC 0.38 mg/L) protein binding
...
#### Klebsiella pneumoniae ATCC 700603 (MIC 12 mg/L)
...
plot(fit5, xlab = "Ceftazidime serum conc. (mg/L)", ylab = "Tpos (hr)")
```
...
#### Klebsiella pneumoniae KP_DAM (MIC 4 mg/L)
